...
class Booking extends Model
{
    ...
    public function product(){
        return $this->belongsTo(Product::class,'service_id', 'id')->withTrashed();
    }
    ...
    public function bookingAddonProduct(){
        return $this->hasMany(BookingProductAddonMapping::class,'booking_id','id')->with('AddonserviceDetails');
    }
    ...
    protected static function boot(){
        ...
        static::deleted(function ($row) {
            ...
            $row->bookingAddonProduct()->delete();
            ...
            if($row->forceDeleting === true)
            {
                ...
                $row->bookingAddonProduct()->withTrashed()->forceDelete();
        ...
        static::restoring(function($row) {
            ...
            $row->product()->withTrashed()->restore();
            ...
            $row->bookingAddonProduct()->withTrashed()->restore();
    ...
    public function getServiceOrProductAttribute()
    {
