...
class Service extends Model implements  HasMedia
{
    ...
    public function translations()
    {
        return $this->hasMany(Translations::class, 'translatable_id')
            ->where('translatable_type', Service::class); // Make sure this is correct
    }
   ...
   public function translate($attribute, $locale = null)
    ...
    public function serviceRating(){
        return $this->hasMany(BookingRating::class, 'service_id','id')->where('type', 'service')->orderBy('created_at','desc');
    }
