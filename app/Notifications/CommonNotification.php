...
class CommonNotification extends Notification implements ShouldQueue
{
    ...
    function sendWhatsAppMessage($data) {
        ...
        $numbers = preg_replace('/[^0-9]/', '', $user->contact_number); // Remove non-numeric characters

        // Check if number is 10 digits, then add '91'
        ...
        try {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => 'https://wback.housingmagic.in/send-message-web',
