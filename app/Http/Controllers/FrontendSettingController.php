...
class FrontendSettingController extends Controller
{
    ...
    public function landingpagesettingsUpdates(Request $request){        
        ...
        $configurations = [
            'section_1' => ['category_id','current_location','current_slider','enable_search','enable_popular_services','enable_popular_provider','provider_id'],
            ...
            'section_10' => ['service_id'],
            'section_11' => ['service_id'],
            'section_12' => ['service_id'],
            'section_13' => ['service_id'],
            'section_14' => ['service_id'],
            'section_15' => ['service_id'],
            'section_16' => ['service_id'],
            'section_17' => ['service_id'],
            'section_18' => ['subcategory_id'],
            'section_19' => ['service_id'],
        ];
    ...
    public function landingLayoutPage(Request $request){
        ...
        switch ($tabpage) {
            ...
            case 'section_11':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_11'] = $decodedata->section_11;
                        $landing_page['title'] = $decodedata->title;
                        $landing_page['service_id'] = $decodedata->service_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
            ...
            case 'section_12':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_12'] = $decodedata->section_12;
                        $landing_page['title'] = $decodedata->title;
                        $landing_page['service_id'] = $decodedata->service_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
            ...
            case 'section_13':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_13'] = $decodedata->section_13;
                        $landing_page['title'] = $decodedata->title;
                        $landing_page['service_id'] = $decodedata->service_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
            ...
            case 'section_14':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_14'] = $decodedata->section_14;
                        $landing_page['title'] = $decodedata->title;    
                        $landing_page['service_id'] = $decodedata->service_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
            ...
            case 'section_15':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_15'] = $decodedata->section_15;
                        $landing_page['title'] = $decodedata->title;    
                        $landing_page['service_id'] = $decodedata->service_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
            ...
            case 'section_16':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_16'] = $decodedata->section_16;
                        $landing_page['title'] = $decodedata->title;
                        $landing_page['service_id'] = $decodedata->service_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
            ...
            case 'section_17':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_17'] = $decodedata->section_17;
                        $landing_page['title'] = $decodedata->title;
                        $landing_page['service_id'] = $decodedata->service_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
            ...
            case 'section_18':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_18'] = $decodedata->section_18;
                        $landing_page['title'] = $decodedata->title;
                        $landing_page['subcategory_id'] = $decodedata->subcategory_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
                    break;
            ...
            case 'section_17':
                    if(!empty($landing_page['value'])){
                        $decodedata = json_decode($landing_page['value']);
                        $landing_page['section_19'] = $decodedata->section_19;
                        $landing_page['title'] = $decodedata->title;
                        $landing_page['service_id'] = $decodedata->service_id;
                    }
                    $data  = view('forntend-setting-landing.'.$tabpage, compact('user_data','tabpage','landing_page'))->render();
