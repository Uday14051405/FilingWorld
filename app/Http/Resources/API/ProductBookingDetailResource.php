...
class ProductBookingDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'price_format'       => getPriceFormat(optional($this->product)->price),
            'type'               => optional($this->product)->type,
            ...
            'service_name'       => $this->getTranslation(optional($this->product)->translations, $headerValue, 'name', optional($this->product)->name ?? null) ?? optional($this->service)->name,
            ...
            'duration_diff_hour' => ($this->product->type === 'hourly') ? convertToHoursMins($this->duration_diff) : null,
            ...
            'booking_package'              => new ProductBookingPackageResource($this->bookingPackage),
            'advance_paid_amount'  => $this->advance_paid_amount == null ? 0:(double) $this->advance_paid_amount,
            'advance_payment_amount' => optional($this->product)->advance_payment_amount == null ? 0:(bool) optional($this->product)->advance_payment_amount,
