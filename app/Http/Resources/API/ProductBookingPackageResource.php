...
class ProductBookingPackageResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $service_id = PackageProductMapping::where('service_package_id',$this->service_package_id)->pluck('service_id');
        ...
        if ($services) {
            foreach ($services as $serviceItem) {
                ...
                $service = Product::find($serviceItem->service_id); // Fetch service details by service_id
