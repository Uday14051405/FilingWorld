...
class BookingWithTaxExport implements FromQuery, WithHeadings, WithMapping
{
    protected $columns;
    protected $query;
    ...
    {
        return $this->query->with(['service', 'customer', 'provider', 'payment', 'handymanAdded', 'commissionsdata']);
    }
    ...
    public function map($booking): array
    {
        ...
        $columnMap = [
            ...
            'colTax' => fn() => $booking->final_total_tax ? getPriceFormat($booking->final_total_tax) : '0.00',
    ...
    public function headings(): array
    {
        $headingsMap = [
            ...
            'colFinalTax' => 'Tax', // Added Final Tax Column
