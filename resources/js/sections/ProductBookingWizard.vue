<template>
    ...
    <div class="row">
          ...
          <div class="row align-items-center">
            <div class="col-lg-3 col-md-4">
              <div class="img flex-shrink-0">
                <img :src="service.service_image" class="object-cover rounded-3 w-100 img-fluid book-service-img"
                  alt="product">
              </div>
            </div>
                ...
                <div class="d-flex align-items-center flex-wrap gap-2 mt-4">
                  <div class="d-inline-flex align-items-center gap-2 felx-shrink-0">
                    <div class="flex-shrink-0">
                      <img :src="service.provider_image" alt="product" class="img-fluid rounded-3 object-cover avatar-24">
                    </div>
                  ...
                  <div v-if="!service.is_enable_advance_payment">/</div>
                  <div v-if="!service.is_enable_advance_payment" class="d-inline-flex align-items-center gap-2 flex-shrink-0">
                    <span class="font-size-14 service-user-name">{{ $t('messages.cod') }}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-12" v-else>
        <div class="bg-light p-sm-5 p-3 mb-5 booking-detail-service-box rounded-4">
          <div class="row align-items-center">
            <div class="col-lg-3 col-md-4">
              <div class="img flex-shrink-0">
                <img :src="service.package_image" class="object-cover rounded-3 w-100 img-fluid" alt="product">
              </div>
            </div>
            <div class="col-lg-9 col-md-8 mt-md-0 mt-3">
              <div class="content flex-grow-1">
                <div class="d-sm-flex align-items-center gap-3 justify-content-between">
                  ...
                  <div class="flex-shrink-0 d-inline-flex align-items-center gap-2 mt-sm-0 mt-2">
                    <span class="text-primary fw-500 d-inline-block position-relative font-size-18">{{
                      formatCurrencyVue(service.price) }} (<del>{{ formatCurrencyVue(service.total_price) }}</del>)</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div :class="service.price == 0 ? 'col-lg-12' : 'col-lg-7'">
                  <div class="booking-list-content-active">
                    <h5 class="text-capitalize">{{ $t('messages.book_product') }}</h5>
  
  
                    <div v-if="serviceaddon && serviceaddon.length">
                      <h5 class="mt-5 mb-3">{{ $t('landingpage.Add-ons') }}</h5>
                      <div v-for="(service, index) in serviceaddon" :key="index"
                        ...
                        <div class="flex-shrink-0 provider-image-container">
                          <img :src="service.serviceaddon_image" alt="service-image" class="img-fluid w-100"
                        ...
                        <div>
                          <span class="d-block btn btn-light text-danger" @click="removeAddons(index)">{{
                        ...
                        <div class="row g-3">
                            ...
                            <div class="input-group icon-left custom-form-field flex-nowrap">
                              <span class="input-group-text flex-shrink-0" id="dateandtime">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17"
                                  fill="none">
                                  <path d="M1.32031 6.5531H14.6883" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M11.3322 9.4823H11.3392" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M8.00408 9.4823H8.01103" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M4.66815 9.4823H4.67509" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M11.3322 12.3971H11.3392" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M8.00408 12.3971H8.01103" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M4.66815 12.3971H4.67509" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M11.0329 1V3.46809" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M4.97435 1V3.46809" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                              ...
                              <flat-pickr v-model="date" :config="config" class="form-control"
                                placeholder="Select date and time" name="date" />
                            </div>
                          ...
                          <div v-if="service.type == 'fixed'" class="col-sm-4" :class="{ 'mt-4': service.is_slot == 1 }">
                            ...
                            <div class="custom-form-field">
                              <div class="btn-group iq-qty-btn" data-qty="btn" role="group">
                                ...
                                <input type="text" class="input-display" id="quntity" v-model="quantity" name="quantity"
                                  disabled />
                          ...
                          <div class="col-12 mt-5">
                            ...
                            <div class="input-group icon-left custom-form-field">
                              ...
                              <textarea class="form-control" :placeholder="$t('placeholder.address')" v-model="address"
                ...
                <div class="col-lg-5" v-if="service.price > 0">
                  <div class="booking-list-content">
                    <div class="d-flex justify-content-between">
                      <h5 class="m-0 text-capitalize">{{ $t('landingpage.price_product') }}</h5>
                      <button v-if="SeletedCouponId > 0" class="d-block btn btn-sm py-2 btn-danger text-end"
                        @click="RemoveCoupon()">{{ $t('landingpage.remove_coupon') }}</button>
                    </div>
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            ...
                            <td class="pe-0"><span
                                class="d-block text-primary text-end">{{ formatCurrencyVue(service.price * quantity) }}</span>
                            </td>
                          </tr>
                          <tr v-if="discount > 0">
                            <td class="ps-0"><span class="text-capitalize">{{ $t('messages.discount') }}
                                ({{ service.discount }}% off)</span>
                            </td>
                            <td class="pe-0"><span
                          ...
                          <tr
                            v-if="coupons != '' && SeletedCouponId > 0 && selectedCoupon != null && props.service.package_type == null">
                          ...
                          <tr v-if="OpenCouponCard == 1">
                            <td>
                              ...
                              <couponcard @getSelectedCoupon="handleCouponResponse" :coupons=coupons
                                :service_price=service.price :SeletedCouponId=SeletedCouponId></couponcard>
                          ...
                          <tr>
                            ...
                            <td class="pe-0"><span class="d-block text-primary text-end">{{ formatCurrencyVue(subtotal ||
                                0) }}</span></td>
                          </tr>
  
                          <tr>
                            <td class="ps-0"><span class="text-capitalize">{{ $t('landingpage.tax') }}</span></td>
                            <td class="pe-0"><span class="d-block text-danger text-end"><i v-if="taxAmount > 0"
                                  class="fa fa-info-circle text-body cursor-pointer" aria-hidden="true"
                                  @click="openTaxModel()"></i> +{{ formatCurrencyVue(taxAmount || 0) }}</span></td>
                          </tr>
                          ...
                          <tr v-if="service.is_enable_advance_payment == 1">
                            <td class="border-bottom-0 ps-0 pt-3">
                              <h5 class="m-0 text-capitalize">{{ $t('messages.advance_payment_amount') }}
                    ...
                    <div class="mt-5 pt-md-5 pt-3 text-md-end">
                      <div class="d-inline-flex align-items-center flex-wrap gap-3">
                        ...
                        <a v-if="!service.package_type" :href="`${baseUrl}/product-detail/${service.id}`"
                          class="btn btn-outline-primary">{{ $t('landingpage.cancel') }}</a>
                        <a v-if="service.package_type" :href="`${baseUrl}/product-detail/${service.service_id}`"
                          class="btn btn-outline-primary">{{ $t('landingpage.cancel') }}</a>
      ...
      <div class="modal fade show couponmodal" id="taxModal" v-if="is_tax == 1" tabindex="-1"
