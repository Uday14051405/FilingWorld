...
export const SUBCATEGORY_API = (queryPerams) => {return `${BASE_URL}/subcategory-list?${generateQueryParams(queryPerams)}`}
...
export const PRODUCT_API = (queryPerams) => {return `${BASE_URL}/product-list?${generateQueryParams(queryPerams)}`}
