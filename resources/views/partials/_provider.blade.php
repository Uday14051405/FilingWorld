...
<div class="mb-3">
    <ul class="nav nav-tabs pay-tabs nav--tabs__style2 provider-detail-tab">
        ...
        <li class="nav-item {{request()->routeIs('provider.technical-data') ? 'active' : ''}}">
            <a class="nav-link" href="{{ route('provider.technical-data',$providerdata->id) }}">{{__('messages.technical_answers')}}</a>
        </li>
        <li class="nav-item {{request()->routeIs('provider.service-data') ? 'active' : ''}}">
            <a class="nav-link" href="{{ route('provider.service-data',$providerdata->id) }}">{{__('messages.service_answers')}}</a>
        </li>
    </ul>
</div>
