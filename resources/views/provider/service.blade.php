            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('provider.service-data.save', $providerdata->id) }}" method="POST">
                            @csrf
                            <p style="font-size: large;">Will <b>{{ $providerdata->first_name }}</b> able to provide this service?</p>
