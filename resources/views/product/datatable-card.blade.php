<div class="service-box-card bg-light rounded-3 mb-5" data-service-id="{{ $data->id }}">
   ...
   @if(!$data->is_enable_advance_payment)
   <div style="margin-left: 10px;">
      <img src="{{ asset('images/cod.png') }}" alt="COD" style="width: 40px; height: auto;">
   </div>
   @endif
</div>
   ...
   <div
      ...
      <div class="d-flex justify-content-between align-items-center mt-3">
         ...
         <a href="{{ route('book.product', ['id' =>$data->id]) }}" class="btn btn-sm btn-primary">
            {{ __('Book Now') }}
         </a>
         @else
         <a href="{{ route('user.login', ['product_id' =>$data->id]) }}" class="btn btn-sm btn-primary">
            {{ __('Book Now') }}
         </a>
         @endif
      </div>
