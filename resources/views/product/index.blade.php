                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            @if ($auth_user->can('product add') && Route::currentRouteName() !== 'servicepackage.service')
                                <a href="{{ route('product.create') }}" class="float-end me-1 btn btn-sm btn-primary "><i
                                        class="fa fa-plus-circle"></i>
                                    {{ __('messages.add_form_title', ['form' => __('messages.product')]) }}</a>
                            @endif
                        </div>
            ...
            <div class="card-body">
                <div class="row justify-content-between gy-3">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="col-md-12">
                            <form action="{{ route('product.bulk-action') }}" id="quick-action-form"
                                ...
                                <button id="quick-action-apply" class="btn btn-primary" data-ajax="true"
                                    data--submit="{{ route('product.bulk-action') }}" data-datatable="reload"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                    "type": "GET",
                    "url": '{{ route('product.service-index-data', ['postrequestid' => $postrequestid, 'servicepackage' => $servicepackage]) }}',
                    "data": function(d) {
                        d.search = {
                            value: $('.dt-search').val()
                        };
