...
<a href="{{ route('product.create') }}" class=" float-end me-1 btn btn-sm btn-primary "><i class="fa fa-plus-circle"></i> {{ __('messages.add_form_title', ['form' => __('messages.product')]) }}</a>
@endif -->
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                    "type": "GET",
                    "url": '{{ route('product.user-index-data') }}',
                    "data": function(d) {
                        d.search = {
                            value: $('.dt-search').val()
                        };
