                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <a href="{{ route('productaddon.index') }}" class=" float-end btn btn-sm btn-primary"><i
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{ html()->form('POST', route('productaddon.store'))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->id('serviceaddon')->open() }}
                            ...
                            <div id="form-language-{{ $language['id'] }}" class="language-form" style="display: {{ $language['id'] == app()->getLocale() ? 'block' : 'none' }};">
                                ...
                                @php
                                    if ($auth_user->user_type == 'admin' || $auth_user->user_type == 'demo_admin') {
                                        $route = route('product.ajax-list', ['type' => 'service-list', 'language_id' => $language['id']]);
                                    } else {
                                        $route = route('product.ajax-list', [
                                            'type' => 'service-list',
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="service_id"
                                            ...
                                            class="form-control select2js-service"
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="form-group col-md-4">
                                ...
                                @php
                                    if ($auth_user->user_type == 'admin' || $auth_user->user_type == 'demo_admin') {
                                        $route = route('product.ajax-list', ['type' => 'service-list']);
                                    } else {
                                        $route = route('product.ajax-list', [
                                            'type' => 'service-list',
                                            'provider_id' => $auth_user->id,
