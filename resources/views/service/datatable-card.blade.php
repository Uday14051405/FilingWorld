<div class="service-box-card bg-light rounded-3 mb-5" data-service-id="{{ $data->id }}">
   <div class="iq-image position-relative">
      ...
      @endif
      @php
         $mediaItems = $data->getMedia('service_attachment');
         $imageUrl = null;
      ...
      <a href="{{ route('service.detail', $data->id) }}" class="service-img">
         <img src="{{ $imageUrl ?? asset('images/default.png') }}" alt="service"
   ...
   <a href="{{ route('service.detail', $data->id) }}" class="service-heading mt-4 d-block p-0" style="white-space: nowrap;">
   ...
   <div
      ...
      <div class="d-flex justify-content-between align-items-center mt-3">
         ...
         <a href="{{ route('book.service', ['id' =>$data->id]) }}" class="btn btn-sm btn-primary">
            {{ __('Book Now') }}
         </a>
         @else
         <a href="{{ route('user.login', ['service_id' =>$data->id]) }}" class="btn btn-sm btn-primary">
            {{ __('Book Now') }}
         </a>
         @endif
      </div>
