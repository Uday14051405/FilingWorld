...
<!-- Banner -->
<div class="padding-top-bottom-30 bg-light">
    <div class="container-fluid">
       <div class="row align-items-center">
          <div class="col-xl-6">
            ...
            {{-- <div class="d-flex align-items-center justify-content-around flex-wrap gap-2">
                <div class="iq-title-box mb-0">
                    <h4 class="text-capitalize text-capitalize-cate line-count-1">{{ $sectionData['section_2']['title'] }}</h4>
                </div>
            ...
            <div class="d-flex align-items-center justify-content-around flex-wrap gap-2">
                <div class="iq-title-box mb-0">
                    <h4 class="text-capitalize text-capitalize-cate line-count-1">{{ $sectionData['section_18']['title'] }}</h4>
                </div>
                <a href="{{ route('subcategory.list') }}"
                class="btn btn-link p-0 text-capitalize flex-shrink-0 font-size-14" hidden>{{__('messages.view_all')}}</a>
            </div><br>
            @if ($sectionData && isset($sectionData['section_18']) && $sectionData['section_18']['section_18'] == 1)
                <sub-category-section></sub-category-section>
            @endif
          </div>
        ...
        @if($sectionData['section_1']['current_slider'] == "on")
        <div class="col-xl-6 px-xl-0 mt-xl-0 mt-5">
  <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" style="width: 100% !important;">
    <div class="carousel-inner">
      <!-- Slide 1 -->
      <div class="carousel-item active">
        <img src="{{ asset('images/slider/slide_1.png') }}" class="d-block w-100 img-fluid border-radius-12" alt="Slide 1">
      </div>
      <!-- Slide 2 -->
      <div class="carousel-item">
        <img src="{{ asset('images/slider/slide_2.png') }}" class="d-block w-100 img-fluid border-radius-12" alt="Slide 2">
      </div>
      <!-- Slide 3 -->
      <div class="carousel-item">
        <img src="{{ asset('images/slider/slide_3.png') }}" class="d-block w-100 img-fluid border-radius-12" alt="Slide 3">
      </div>
...
<!-- Categories -->
{{-- @if ($sectionData && isset($sectionData['section_2']) && $sectionData['section_2']['section_2'] == 1)
<div class="section-padding" style="padding: 2.125rem 1rem !important;">
    <div class="container">
...
<!-- Products -->
{{-- @if ((isset($sectionData['section_10']) && $sectionData['section_10']['section_10'] == 1) || (isset($sectionData['section_11']) && $sectionData['section_11']['section_11'] == 1))
 <div class="section-padding bg-light our-service" style="padding: 2.125rem 1rem !important;">
    <div class="container">
        @if ($sectionData && isset($sectionData['section_10']) && $sectionData['section_10']['section_10'] == 1)
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <a href="{{ route('product.list', ['sec' => 'section_10']) }}" class="btn btn-link p-0 flex-shrink-0">{{__('messages.view_all')}}</a>
            </div>

            <product-slider-section :user_id="{{json_encode($auth_user_id)}}" :user_type={{json_encode($auth_user_type)}} :favourite="{{json_encode($favourite)}}" :type="'ac'"/>
            </div>
        @endif

        @if ($sectionData && isset($sectionData['section_11']) && $sectionData['section_11']['section_11'] == 1)
            <div class="mt-5">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div class="iq-title-box mb-0">
                    <h3 class="text-capitalize line-count-1">{{ $sectionData['section_11']['title'] }}
                    ...
                    <a href="{{ route('product.list', ['sec' => 'section_11']) }}" class="btn btn-link p-0 flex-shrink-0">{{__('messages.view_all')}}</a>
                </div>
                <product-slider-section :user_id="{{json_encode($auth_user_id)}}" :user_type={{json_encode($auth_user_type)}} :favourite="{{json_encode($favourite)}}" :type="'cleaning'"/>
            </div>
        @endif
    </div>
</div>
    ...
    <div class="container">
        @if ($sectionData && isset($sectionData['section_3']) && $sectionData['section_3']['section_3'] == 1)
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <a href="{{ route('service.list', ['sec' => 'section_3']) }}" class="btn btn-link p-0 flex-shrink-0">{{__('messages.view_all')}}</a>
            </div>
        ...
        @if ($sectionData && isset($sectionData['section_4']) && $sectionData['section_4']['section_4'] == 1)
            <div class="mt-5">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <a href="{{ route('service.list', ['sec' => 'section_4']) }}" class="btn btn-link p-0 flex-shrink-0">{{__('messages.view_all')}}</a>
                </div>
...
<div class="section-padding bg-light px-0"  style="padding: 2.125rem 1rem !important;">
    ...
    <div class="container">
        ...
        <div class="row align-items-center mt-5 pt-lg-5">
            <div class="col-lg-6 pe-xl-5 position-relative">
                <!-- @if($mediaVimage)
                    <img src="{{asset('images/slider/24itsupportvideo.mp4')}}" alt="video-popup" class="img-fluid w-100 rounded">
                @else
                    <img src="{{asset('images/slider/24itsupportvideo.mp4')}}" alt="video-popup" class="img-fluid w-100 rounded">
                @endif
                    @include('landing-page.components.widgets.video-popup', ['videoLinkUrl' => $sectionData['section_7']['url']]) -->
                    
                    <img src="{{asset('images/slider/slide_2.png')}}" alt="video-popup" class="img-fluid w-100 rounded">
            </div>
            <div class="col-lg-6 mt-lg-0 mt-5 ps-xl-5">
                @if(isset($sectionData['section_7']['subtitle']) && isset($sectionData['section_7']['subdescription']))
                    @for($i = 0; $i < min(count($sectionData['section_7']['subtitle']), count($sectionData['section_7']['subdescription'])); $i++)
                        <div class="border-bottom" style="margin-bottom: 10px !important; padding-bottom: 10px !important;">
...
@if (isset($sectionData['section_19']) && $sectionData['section_19']['section_19'] == 1)
 <div class="section-padding bg-light our-service" style="padding: 2.125rem 1rem !important;">
    <div class="container">
        @if ($sectionData && isset($sectionData['section_19']) && $sectionData['section_19']['section_19'] == 1)
            <div>
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div class="iq-title-box mb-0">
                    <h3 class="text-capitalize line-count-1">{{ $sectionData['section_19']['title'] }}
                    <div class="highlighted-text">
                        <span class="highlighted-text-swipe"></span>
                        <span class="highlighted-image">
                            <svg xmlns="http://www.w3.org/2000/svg" width="155" height="12" viewBox="0 0 155 12"
                ...
                <a href="{{ route('blog.list') }}" class="btn btn-link p-0 flex-shrink-0">{{__('messages.view_all')}}</a>
            </div>

            <blog-page-index link="{{ route('blog.data', ['sec' => 'section_19']) }}"></blog-page-index>
            </div>
        @endif
    </div>
</div>
