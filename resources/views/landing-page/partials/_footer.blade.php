...
@endphp
    <div class="footer-top">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="footer-inner-box" style="padding-top: 50px;">
                        {{-- @include('landing-page.components.widgets.logo') --}}
                        <p class="mt-5 mb-0 readmore-text" style="margin-top: 0px !important;">
                ...
                <div class="col-lg-7 custom-border-left mt-lg-0 mt-5 pt-lg-0 pt-3">
                    ...
                    <div class="footer-inner-box position-relative ps-lg-5 h-100" style="padding-top: 50px;">
    ...
    <div class="footer-bottom py-3 position-relative">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end text-center">
                    <span class="d-inline-flex align-items-center gap-3 flex-wrap">
                        <a target="_blank" href="{{ route('blog.list') }}" class="text-body link-primary">{{__('landingpage.blogs')}}</a>
