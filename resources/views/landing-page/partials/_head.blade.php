...
<title>{{env('APP_NAME')}} - Online GST Filing, Tax Return & Company Registration in India</title>
<link rel="shortcut icon" class="favicon_preview" href="{{ getSingleMedia(imageSession('get'),'title_logo',null) }}" />
...
<script>
    ...
    const savedPrimaryColor = localStorage.getItem('primaryColor') ?? '#F50000';
