...
<header>
    ...
    <div class="top-header bg-primary">
       <div class="container-fluid" style="padding: 0 2.25rem;">
    ...
    <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar header-hover-menu py-xl-0 ">
       <div class="container-fluid navbar-inner" style="padding: 0 2.25rem;">
          <div class="d-flex align-items-center justify-content-between w-100 landing-header">
             <div class="d-flex gap-3 gap-xl-0 align-items-center">
                <div>
                   <button data-trigger="navbar_main" id="res_sidebar" style="font-size: x-large; width: 40px; height: 43px; border-radius: 5px !important;"
             ...
             <div class="right-panel">
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" style="border: 2px solid grey; height: 40px; width: 40px;"
                   data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false"
                   aria-label="Toggle navigation">
                   <i class="fa-solid fa-user" style="font-size: x-large;"></i>
                </button>
