                ...
                <div class="py-5 d-flex flex-column justify-content-center h-100">
                    <div class="row justify-content-center">
                        ...
                        <a href="{{route('frontend.index')}}">
                           <img src="{{ getSingleMedia(imageSession('get'),'logo',null) }}" class="img-fluid rounded-normal" alt="logo" style="max-width: 50%;">
                        </a>
                     </div>
                            ...
                            <div class="authontication-forms">
                                ...
                                <div class="iq-login-form ">
                                    ...
                                    <form id="loginForm" data-toggle="validator" method="post">
                                        ...
                                        <div class="form-group icon-right mb-5 custom-form-field">
                                            <label>{{__('landingpage.email_or_mobile')}} <span class="text-danger">*</span></label>
                                            <input type="text" id="email" name="email" class="form-control" 
                                                placeholder="{{__('placeholder.email_or_mobile')}}"
                                                aria-label="Login Input" required>
                                            <small class="help-block with-errors text-danger"></small>
                                        </div>
                ...
                success: function(response) {
                    if(response.data){
                       if(serviceId !=null){
                        ...
                        window.location.href = baseUrl + '/book-product?id=' + productId;
