...
<div class="form-group">
    <div class="form-control d-flex align-items-center justify-content-between">
                <label class="mb-0" for="enable_section_10">{{__('messages.enable_section_10')}}</label>
        ...
        <div class="form-section" id='enable_section_10'>
    <div class="form-group">
    ...
    <div class="form-group" id="enable_select_service">
        ...
        {{ html()->select('service_id[]', [],old('service_id'))
            ...
            ->attribute('data-ajax--url', route('product.ajax-list', ['type' => 'product', 'hot_selling' => 1]))
            ->multiple()
        }}
    </div>
...
<script>
    ...
    checkSection3(enable_section_10);
    ...
    function getConfig(type) {
        ...
        $.ajax({
            ...
            success: function (response) {
                var obj = '';
                var section_10 = title = service_ids = '';
