            ...
            <div class="card-body">
                <div class="row align-items-center justify-content-between gy-3">
                    <div class="row align-items-center mb-3">
                        <!-- First Column: Total, Breakdown, Export -->
                        <div class="col-md-6 col-lg-4 col-xl-5">
                            <div class="d-flex flex-wrap align-items-center gap-3">
                                @if (!auth()->user()->hasAnyRole(['user']))
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#breakdownModal" class="text-success">View Breakdown</a>
                                @endif
                                <button type="button" class="btn btn-sm btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#Export">
                                    {{ __('messages.export') }}
                                </button>
                            </div>
                        </div>

                        <!-- Second Column: Booking Type -->
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group datatable-filter mb-0">
                                <select name="booking_type" id="booking_type" class="form-control select2" data-filter="select">
                                    <option hidden value="">Select Booking Type</option>
                        ...
                        <!-- Third Column: Search and Filter -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="colType" checked />
                                <label class="form-check-label" for="colType">{{ __('messages.booking_type') }}</label>
                            </div>
                            <div class="form-check">
            ...
            window.renderedDataTable = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'booking_type',
                        name: 'booking_type',
                        title: "{{ __('messages.booking_type') }}",
                        searchable: true
                    },
                    {
                        data: 'customer_id',
