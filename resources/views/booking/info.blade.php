                                ...
                                <div class="w3-third">
                                    ...
                                    <div class="w3-third">
                                        @if($bookingdata->type == "service")
                                            @if($bookingdata->handymanAdded->count() == 0 && $bookingdata->status !== "cancelled")
                                                @hasanyrole('admin|demo_admin|provider')
                                                <a href="{{ route('available.data', ['service_id'=> $bookingdata->service_id, 'user_type'=> 'provider']) }}" target="_blank"
                                    ...
                                    <div class="w3-third">
                                        @if($bookingdata->type == "service")
                                            @if($bookingdata->handymanAdded->count() == 0 && $bookingdata->status !== "cancelled")
                                                @hasanyrole('admin|demo_admin|provider')
                                                <a href="{{ route('available.data', ['service_id'=> $bookingdata->service_id, 'user_type'=> 'engineer']) }}" target="_blank"
                                                class=" float-end btn btn-primary"><i class="lab la-telegram-plane"></i>
