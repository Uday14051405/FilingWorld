...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    // Product API Routes
    Route::get('get-coupon-product',[API\ProductCommanController::class,'getCouponService']);
    Route::post('product-category-save', [ App\Http\Controllers\ProductCategoryController::class, 'store' ] );
    Route::post('product-category-delete/{id}', [ App\Http\Controllers\ProductCategoryController::class, 'destroy' ] );
    Route::post('product-category-action',[ App\Http\Controllers\ProductCategoryController::class, 'action' ]);
    Route::get('get-product-category-list',[API\ProductCategoryController::class,'getCategoryList']);
    
    Route::get('get-product-list',[API\ProductController::class,'getServiceList']);
    ...
    Route::post('get-product-detail', [ API\ProductController::class, 'getServiceDetail' ] );
    
    Route::post('product-subcategory-save', [ App\Http\Controllers\ProductSubCategoryController::class, 'store' ] );
    Route::post('product-subcategory-delete/{id}', [ App\Http\Controllers\ProductSubCategoryController::class, 'destroy' ] );
    Route::post('product-subcategory-action',[ App\Http\Controllers\ProductSubCategoryController::class, 'action' ]);
    Route::get('get-product-subcategory-list',[API\ProductSubCategoryController::class,'getSubCategoryList']);
    
    Route::post('productpackage-save',[  App\Http\Controllers\ProductPackageController::class, 'store' ]);
    Route::get('productpackage-list',[API\ProductPackageController::class,'getServicePackageList']);
    Route::post('productpackage-delete/{id}', [ App\Http\Controllers\ProductPackageController::class, 'destroy' ] );
});
